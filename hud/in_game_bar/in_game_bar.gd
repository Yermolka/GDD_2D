...
@onready var health: TextureProgressBar = $HealthMana/Health
@onready var mana: TextureProgressBar = $HealthMana/Mana
@onready var skill_1: SelectedSkillButton = $SkillBarBackground/Skill0
@onready var skill_2: SelectedSkillButton = $SkillBarBackground/Skill1
@onready var skill_3: SelectedSkillButton = $SkillBarBackground/Skill2
@onready var skill_4: SelectedSkillButton = $SkillBarBackground/Skill3
@onready var skill_5: SelectedSkillButton = $SkillBarBackground/Skill4
@onready var skill_movement: SelectedSkillButton = $SkillBarBackground/Skill5
@onready var cast_bar: ProgressBar = $CastBar

func _set_progress_bar(bar: TextureProgressBar, attribute_spec: AttributeSpec) -> void:
...
func handle_ability_granted(_skill: ActiveSkill) -> void:
    ...
    elif skill_4.ability == null:
        skill_4.ability = _skill
    elif skill_5.ability == null:
        skill_5.ability = _skill
...
func handle_ability_revoked(_skill: ActiveSkill) -> void:
    ...
    elif skill_4.ability == _skill:
        skill_4.ability = null
    elif skill_5.ability == _skill:
        skill_5.ability = null
...
func handle_cooldown_started(ability: ActiveSkill) -> void:
    ...
    elif skill_4.ability == ability:
        skill_4.start_cooldown(ability.cooldown_duration)
    elif skill_5.ability == ability:
        skill_5.start_cooldown(ability.cooldown_duration)
...
func setup_ability_container(ability_container: AbilityContainer) -> void:
    for child in $SkillBarBackground.get_children():
        if child is SelectedSkillButton:
